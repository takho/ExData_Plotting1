#JHU- Exploratory Data Analysis Project1- Plot4
#========================================================
...
# set up the the 2x2 plot, and filling it columnwise, ie graph1 in column1 row1,
# graph2 in column1 row2, graph3 in column2 row1 etc. etc.
# set margin to accommodate the x and y axis lables
...
legend("topright", col=c("blue4","red","blue"), lty=c(1,1,1),legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),cex=0.5, bty="n")
